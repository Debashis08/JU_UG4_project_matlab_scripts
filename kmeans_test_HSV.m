...
excelSheetLocation='D:\4TH YEAR\1ST SEMESTER\Project_1\MATRICES_WORKSPACES\BLACK_SUNRISE_HSV\135_Degree_GLCM\'; %%<--change this folder name to the desired folder name...according to the offset applied...
for i=1:4
    if i==1
